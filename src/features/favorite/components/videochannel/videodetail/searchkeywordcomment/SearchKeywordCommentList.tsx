...
import { useSearchKeywordCommentList } from "../../../../hooks/videochannel/videodetail/searchkeywordcomment/useSearchKeywordCommentList";
import { SearchKeywordCommentType } from "../../../../types/videodetail/videosearchkeywordcomment/SearchKeywordCommentType";
import { SearchKeywordCommentContent } from "./SearchKeywordCommentContent";
...
export function SearchKeywordCommentList() {

    console.log("SearchKeywordCommentList render");

    const {
        isLoading,
        searchCommentData,
        errMessage, } = useSearchKeywordCommentList();
