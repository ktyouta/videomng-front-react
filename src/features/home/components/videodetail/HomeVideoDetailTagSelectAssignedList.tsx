...
type propsType = {
    ...
    deleteTagEditList: (deleteIndex: number) => void;
}

export function HomeVideoDetailTagSelectAssignedList(props: propsType) {
            ...
            <TagEditAreaDiv>
                ...
                </TagListTitleDiv>
                {
                    props.selectedTagList.length > 0
                        ...
                        <TagListAreaDiv>
                            {
                                props.selectedTagList.map((e: tagType, index: number) => {
